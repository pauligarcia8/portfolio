...
export default function Home() {
  return (
    <div className="mx-auto max-w-screen-xl px-6 py-12 md:px-12 md:py-16 lg:py-0 items-center justify-items-center min-h-screen p-5 font-[family-name:var(--font-geist-mono)]">
      ...
      <main className="h-screen w-full flex flex-col items-start justify-center font-[family-name:var(--font-geist-sans)] ">
      ...
      <section className="h-screen w-full flex flex-col items-center justify-center">
        ...
        <p>
          ...
          I’ve used various styling libraries like Bootstrap, Material UI,

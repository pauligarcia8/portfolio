...
export default function Home() {
  return (
    <div className="mx-auto max-w-screen-xl px-6 py-12 md:px-12 md:py-16 lg:py-0 items-center justify-items-center min-h-screen p-5 font-[family-name:var(--font-geist-mono)]">
      ...
      <main className="h-[90vh] w-full flex flex-col items-start justify-center font-[family-name:var(--font-geist-sans)] ">
        ...
        <section className="h-[90vh] w-full flex flex-col items-center justify-center">
          <p>
            ...
            above all, collaboration to achieve coherent results. I began my web
            development career learning HTML, CSS, and JavaScript, which allowed
            me to build dynamic and attractive interfaces. Later, I deepened my
            knowledge in React, a powerful JavaScript library that has enabled
            me to create more efficient and scalable web applications. I’ve used
            various styling libraries like Bootstrap, Material UI, Tailwind, and
            Storybook to preview components and have been involved in the
            project lifecycle through agile methodologies. I am proactive,
            patient, and adaptable, always focused on achieving excellent
            results. Additionally, I have a strong ability to build solid
            relationships with clients, thanks to my proficiency in English.
            Currently, I am studying to become a Systems Analyst to gain a solid
            foundation in programming. This learning will enable me to explore
            and master various languages and skills in the technology world,
            allowing me to continue growing professionally and face new
